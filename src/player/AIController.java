...
public class AIController {
	...
	public int amountToSleep() {
		...
		// If it is a valid slap time, a shorter delay
			...
			// If the round is over because no further plays are possible, delay will be larger
			else {
				return minDelay;
			}
		}
	...
	public boolean makeMove() {
		// Attempts to make a move: returns false if a move was made, true if a move wasn't made
