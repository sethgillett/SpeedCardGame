...
public class SpitGame {
	...
	return p.stacksEmpty() || ai.stacksEmpty() || (leftDraw.isEmpty() && rightDraw.isEmpty() && this.isRoundOver());
    }
	...
	// Checks if either player's cards can be placed on top of the current spit
	// piles
